...
public class MessageUtil {
	  private final static String AUTH = "AIzaSyCh7VF4yeqBiKFcSf6NY_ZTe2elEG2vpeg";

	  private final static String SENDER_ID = "611271756621";
	  ...
	  public static int sendMessage(String auth_token, String registrationId,
	    ...
	    //conn.setRequestProperty("Sender", "id=" + SENDER_ID);
